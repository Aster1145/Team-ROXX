...
const teamLeads = [
  ...
  {
    name: "Software & Biz Lead",
    role: "Vice Captain",
    department: "Business & Software",
    bio: "Overseeing cloud dashboard architecture, corporate partnerships, and documentation.",
...
const departments = [
  ...
  },
  {
    ...
    name: "Docs & Media",
    lead: "Media & Reports Lead",
    role: "Media Lead",
    image: "/images/team-2.jpg",
    icon: FileText,
    color: "from-rose-500 to-pink-500",
    description: "Technical documentation, whitepapers, social media storytelling, and press outreach.",
  },
];
